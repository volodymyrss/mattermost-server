...
// GetChannelsWithChannelScopePermission provides a mock function with given fields: channelIds
func (_m *ChannelStore) GetChannelsWithChannelScopePermission(userID string, permissionName string) store.StoreChannel {
